...
Ayarlarda e-posta magic-link girişi, geçerli kullanıcı, senkronizasyon durumu ve son başarılı eşitleme zamanı görünür. Girişten sonra eşitleme tamamen otomatiktir; manuel bulut indirme/yükleme veya bulut üzerine yazma kontrolleri gösterilmez. JSON dışa aktarma ve içe aktarma, **Gelişmiş yedekleme** bölümünde kalır.

Güvenli revizyon denetimli yazma için ayrıca [supabase/migrations/002_safe_progress_write.sql](supabase/migrations/002_safe_progress_write.sql) dosyasını SQL Editor’da çalıştırın. Uygulama önce son bulut durumunu alır, kayıtları kimliğe ve zaman damgasına göre birleştirir, sonra bu fonksiyonla beklenen revizyonu doğrulayarak yazar. Çevrimdışıyken tüm değişiklikler cihazda korunur ve bağlantı döndüğünde otomatik olarak yeniden denenir.
