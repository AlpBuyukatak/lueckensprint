...
assert.ok(css.includes('width:clamp(3.8ch')&&css.includes('text-indent:0!important')&&css.includes('box-shadow:inset 0 0 0 2px var(--gold)'),'C-Test gaps need enough left text space and a non-overlapping focus indicator.');
