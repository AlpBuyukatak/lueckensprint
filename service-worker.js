const CACHE='lueckensprint-v1.1.0';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.json','./icons/icon.svg','./data/texts-a1.json','./data/texts-a2.json','./data/texts-b1.json','./data/texts-b2.json','./data/texts-c1.json'];
